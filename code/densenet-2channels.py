...
# Usage:
# python3 /home/cnn2d/code/densenet-2channels.py  --data_path /home/cnn2d/data/N-MNIST  --validation_split 0.2  --batch_size 100  --epochs 300  --lr 0.01  --dropout 0.2  --patience 10  --random_seed 0
# python3 /home/cnn2d/code/densenet-2channels.py  --data_path /home/cnn2d/data/FN-MNIST  --validation_split 0.2  --batch_size 100  --epochs 300  --lr 0.01  --dropout 0.2  --patience 10  --random_seed 0
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Training a 2D-CNN with DenseNet architecture on two-channeled (ON and OFF) images from N-MNIST or FN-MNIST\n'
